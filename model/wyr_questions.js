...
//func to get a random question
function randomWYRQueston() {
    const randomIndex = Math.floor(Math.random() * questions.length)
    //select a random qu using index
    const randomQuestion = questions[randomIndex]
    return randomQuestion
}

//export the func to be used in other modules
module.exports = randomWYRQueston